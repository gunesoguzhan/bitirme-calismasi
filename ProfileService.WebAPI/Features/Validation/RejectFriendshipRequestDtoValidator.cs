...
public class RejectFriendshipRequestDtoValidator : AbstractValidator<RejectFriendshipRequestDto>
{
    private readonly IHttpContextAccessor _httpContextAccessor;

    public RejectFriendshipRequestDtoValidator(IHttpContextAccessor httpContextAccessor)
    {
